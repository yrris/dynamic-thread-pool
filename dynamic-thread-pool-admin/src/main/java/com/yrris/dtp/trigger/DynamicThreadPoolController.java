...
public class DynamicThreadPoolController {
    ...
    public Response<List<ThreadPoolConfigEntity>> queryThreadPoolList() {
        try {
            ...
            return Response.<List<ThreadPoolConfigEntity>>builder()
                    ...
                    .msg(Response.Code.SUCCESS.getMsg())
            ...
            return Response.<List<ThreadPoolConfigEntity>>builder()
                    ...
                    .msg(Response.Code.UN_ERROR.getMsg())
                    .build();
        }
    }
     ...
     * 查询线程池配置
     * curl --request GET \
     * --url 'http://localhost:8089/api/v1/dynamic/thread/pool/query_thread_pool_config?appName=dynamic-thread-pool-test-app&threadPoolName=threadPoolExecutor02'
     */
